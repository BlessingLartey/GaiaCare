...
const BeeKeeping = () => {
  ...
  const options = [
    ...
    },
    {
      ...
      weight: 20,
      defaultDescriptions: [
        "Hive-Splitted training",
        "Honey harvesting training",
      ],
    },
    {
      name: "Baiting and Hive monitoring",
      weight: 15,
  ...
  return (
    <form onSubmit={handleSubmit} className="form-container">
      <h3 className="main-category">Bee Keeping </h3>
